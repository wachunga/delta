...
var Delta = /** @class */ (function () {
    ...
    Delta.prototype.slice = function (start, end) {
        ...
        var ops = [];
        var iter = new Iterator_1.default(this.ops);
        var index = 0;
    ...
    Delta.prototype.compose = function (other) {
        var thisIter = new Iterator_1.default(this.ops);
        var otherIter = new Iterator_1.default(other.ops);
        var ops = [];
    ...
    Delta.Iterator = Iterator_1.default;
